...
const Footer = () => {
    ...
    const onSubmit = (data) => {
        ...
        setTimeout(() => {
            ...
            reset(); // Clear the form input field
        }, 2000);
    };
    ...
    return (
        <div className="bg-[#24231D] w-full">
            <div className="max-w-screen-xl mx-auto px-5 py-20">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-items-center justify-between md:justify-items-start xl:grid-cols-4 gap-5">
                    {/* left side */}
